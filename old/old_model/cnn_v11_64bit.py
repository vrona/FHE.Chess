...
class PlainChessNET(nn.Module):
    ...
    def __init__(self, hidden_layers=2, hidden_size=128):
        ...
        self.output_layer = nn.Conv2d(hidden_size, 1024, kernel_size=3, stride=1, padding=1)
        self.flatten = nn.Flatten()
        
        self.fc1 = nn.Linear(65536, 1024)
        self.batchn1d_1 = nn.BatchNorm1d(1024)
        self.output_from = nn.Linear(1024,64)
        self.output_to = nn.Linear(1024,64)
