...
class PlainChessNET(nn.Module):
    ...
    def __init__(self):
        ...
        self.input_layer = nn.Conv2d(12, 408, kernel_size=3, stride=1, padding=1)
        self.batchn1 = nn.BatchNorm2d(408)
        self.conv2 = nn.Conv2d(408, 204, kernel_size=3, stride=1, padding=1)
        self.batchn2 = nn.BatchNorm2d(204)

        self.flatten = nn.Flatten()
        self.fc1 = nn.Linear(13056, 128)
